        ...
        <Modal.Body>
          <Form onSubmit={postData}>
            ...
            <Form.Group className="mb-3" controlId="formBasicPassword">
              ...
              <Form.Control type="number" placeholder="90" min={1} onChange={(e) => setCouponCode(e.target.value)} />
            </Form.Group>
            <Form.Group className="mb-3" controlId="formBasicPassword">
              <Form.Label>Minimum Order</Form.Label>
              <Form.Control type="number" placeholder="500" min={1} onChange={(e) => setCouponCode(e.target.value)} />
            </Form.Group>
