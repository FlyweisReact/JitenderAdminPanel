...
const Coupon = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const postData = async (e) => {
      e.preventDefault()
      try{
        const { data } = await axios.post("http://ec2-15-206-210-177.ap-south-1.compute.amazonaws.com:5004/api/v1/coupon" , {couponCode, activationDate , expirationDate , discount , minOrder})
      }catch(e){
        console.log(e)
      }
    } 
