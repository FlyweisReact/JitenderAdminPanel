...
const Sub = () => {
  ...
  const subCategory = async () => {
    ...
    try{
      ...
      const {data} = await axios.get('https://desh-deepak-backend.herokuapp.com/api/v1/admin/subCategory' , Auth)
      console.log(data)
      setLoading(false)
        ...
        >
          <div className="bg-slate-100 overflow-y-auto  lg:w-3/6  md:w-4/6 w-5/6 mx-auto  rounded-lg">
            ...
            >
              ...
              <div className="inline-flex  w-full flex-col">
              <input type='text' placeholder="Sub-Category" style={{outline : 'none' , padding : '5px' , borderRadius : '5px'}} />
              </div>
              <button
                type="submit"
