...
const Order = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const assingOrder  = async (e) => {
      try {
        const { data } = await axios.post("http://ec2-65-1-248-95.ap-south-1.compute.amazonaws.com:5004/api/v1/driver/addOrder " , {
          orderId , driverId
        })
        console.log(data)
        alert('Assigned')
    ...
    return (
      ...
      >
       ...
       Assign Order
        ...
        <Form.Select aria-label="Default select example" onChange={(e) => setDriverId(e.ta)}>
