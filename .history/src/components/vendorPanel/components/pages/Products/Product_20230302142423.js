    ...
    const postData = async (e) => {
      ...
      try {
        const { data } = await axios.post(
          "http://ec2-15-206-210-177.ap-south-1.compute.amazonaws.com:5004/api/v1/admin/product/new",
          fd
        );
        console.log(data);
        props.onHide();
          ...
          <Form onSubmit={postData}>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Select aria-label="Default select example">
                <Form.Select aria-label="Default select example" onChange={() => setCategory(e.target.value)}>
            ...
            <Button variant="outline-success" typ>Submit</Button>
          </Form>
        </Modal.Body>
  ...
  const deleteData = async (id) => {
    try {
      const { data } = await axios.delete(
        `http://ec2-15-206-210-177.ap-south-1.compute.amazonaws.com:5004/api/v1/admin/product/${id}`,
        {
          headers: {
