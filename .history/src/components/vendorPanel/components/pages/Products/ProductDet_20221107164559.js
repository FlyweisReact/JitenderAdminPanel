      ...
      <Row>
        ...
        <Col md={3}>
          <Card>
            <Card.Body>
              <ListGroup variant="flush">
                <ListGroup.Item>Categry :  {data?.product?.category} </ListGroup.Item>
                <ListGroup.Item>
                  {" "}
                  ColorAvailbale : {data?.product?.coloursAvailable.map((i) => )} 
                </ListGroup.Item>
                <ListGroup.Item>
                  {" "}
        ...
        <Card style={{ color: "black", marginTop: "5%", width: "40%" }}>
          ...
          >
            <Card>
              <Card.Body>
                <ListGroup variant="flush">
                  <ListGroup.Item>User Name :  {data?.product?.name} </ListGroup.Item>
                  <ListGroup.Item>Rating : {data?.product?.name} </ListGroup.Item>
                  <ListGroup.Item> Comment :  {data?.product?.name} </ListGroup.Item>
                </ListGroup>
              </Card.Body>
            </Card>
            <Card>
