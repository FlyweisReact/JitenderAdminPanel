  ...
  const submitHandler = async (e) => {
    ...
    try {
      const data = await axios.post(
        "https://desh-deepak-backend.herokuapp.com/api/v1/vender/login",
        { email, password }
      );
      navigate("/dashboard");
  ...
  return (
    <>
      <div className="w-full h-screen flex flex-col justify-center items-center bg-slate-100">
        <form className="shadow-2xl w-96 mx-3 sm:mx-0 sm:w-4/5 md:w-4/6 lg:w-4/5 xl:w-1/2 flex flex-col items-center bg-white p-5 md:py-10 rounded-tl-3xl rounded-br-3xl" submitHandler>
